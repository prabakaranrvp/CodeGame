...
function setNewView() {
	...
	var tblContent = '<tr><td> <input id="txtGuess0" type="text" maxlength="6" placeholder="Chance 1" onblur="guess(this);" onkeypress="return runScript(event,this)" autofocus/> </td><td id="indicate0"> </td></tr><tr><td> <input id="txtGuess1" type="text" maxlength="6" placeholder="Chance 2" onblur="guess(this);" onkeypress="return runScript(event,this)" disabled/> </td><td id="indicate1"> </td></tr>';
...
function displayWin(result,txt,chance) {
    ...
    for(var i=0;i<chance;i++) {
        if((document.getElementById("txtGuess"+i)!=null)&&(document.getElementById("txtGuess"+i).value.length!=6)){
