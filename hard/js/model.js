...
$(document).ready(function(){
                ...
                */
                ...
                var data = document.getElementById("six").innerHTML;
                all = data.split(' ');
                //newGame();
                loadSucess();
...
function addChances() {
	...
	if(score>=5) {
		...
		var text = "You Do not have enough coins. <br/><b>You need atleast 6 coins to add chances.</b><br/> Play and win to get coins";
